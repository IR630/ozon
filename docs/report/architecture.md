...
p95-медленный такт 11 товаров/мин; решение→команда 1,90 с (p95 2,27 с).
...
Три актуальных полных census дали `33/33 ×3`. Ограничение честности: seed
фиксирует сцену и ориентации, но контактная физика Gazebo имеет небольшой шум;
поэтому метрика принимается только по повторным прогонам с сохранённым triage.
