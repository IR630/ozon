...
истине. Мульти-seed по пяти seed-ам до depth-scale — `162–165/165` (величина
run-to-run; на ядре с E-stop — 162/165), все промахи — околопороговые по K
товары (Шлем, Мешок у 0.8), execution 0. Новый depth-scale пока подтверждён
одним полным seed и не переобъявляет этот пяти-seed знаменатель.
