...
## Результат: текущая перепись 33/33; до depth-scale — 162–165/165 по пяти seed
...
всех). После depth-scale fix выполнен один полный seed 33/33, поэтому диапазон
ему не приписывается. Инвариант широких прогонов: **каждый промах —
