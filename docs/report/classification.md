...
## Результат: мульти-seed перепись 163/165; до depth-scale fix — 162–165/165

Актуальный статус — **мульти-seed перепись 163/165** (5 seed × 33 ячейки, 22.07,
`runs/a2sweep_*`) при распределении `33/32/33/33/32`: непрерывная body-scored
перепись **33/33** — свойство seed 0, а не решения (все 11 моделей × 3
seed-ориентации, classification 0, execution 0; `docs/experiments.md`
2026-07-20 и 2026-07-21). Более ранняя широкая проверка до принятого
depth-scale fix давала по пяти seed-ам **run-to-run величину 162–165/165**
(165 на ядре до фикса K, 164 до E-stop, 162 на ядре с E-stop; execution 0 во
всех) — тот же механизм отказа на другом ядре. Инвариант широких прогонов: **каждый промах —
