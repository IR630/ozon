...
## Результат: перепись 33/33, по пяти seed — 164/165
...
**164/165**: единственный промах — Мешок в одной ориентации у порога
`K=0.8004`, и перепрогон той же ориентации дал B 8/8, то есть это run-to-run
оседание физики, а не свойство позы. Исторические pre-v0.5 census `33/33 ×3`
сохраняются как история в `mechanism.md`, а не как текущая заявка. Ранние
промахи закрыты и разобраны:
