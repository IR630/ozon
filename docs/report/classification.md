...
## Результат: текущая перепись 33/33; последний однокамерный multi-seed — 163/165
...
всех). Последний однокамерный прогон на depth-scale базе дал **163/165**:
33/32/33/33/32, два промаха и оба классификационные. Он выполнен fallback-путём
камерной исследовательской ветки; точный последующий `main` подтверждён одним
полным seed 33/33. Инвариант широких прогонов: **каждый промах —
