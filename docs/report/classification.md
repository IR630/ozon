...
агрегации и подтверждены end-to-end: финальный gate ядра — census `33/33`
(classification 0, execution 0) и два полных потоковых suite `33/33 + 33/33`
подряд (сводка — `soak.md`, журнал — `docs/experiments.md` 2026-07-17).
