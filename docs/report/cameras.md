...
- **салатовый прямоугольник справа в каждом кадре `y=-0.90`** — корпус
  ПРОТИВОПОЛОЖНОЙ боковой головки в кадре. Это режим отказа §4, сфотографированный,
  а не вычисленный.
...
- **Новый режим отказа:** корпус боковой головки в кадре соседней сливается с
  ...
  возвращает `None` — полный тихий отказ. **Виден на рисунке в §1** — салатовый
  прямоугольник справа в каждом кадре `y=-0.90`. Закрыт тестом
