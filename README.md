...
сдачей*. Пять клипов, которые играет слайд 6, лежат прямо в репозитории
...
|---|---|---|
| `01-video-demo` | видеодемонстрация решения | 10 клипов сквозных прогонов и исходов правила + постеры и сценарий ролика |
