...
|---|---|---|
| `01-video-demo` | видеодемонстрация решения | смонтированный ролик `demo_reel.mp4` (5:44), ролик переписи `census_reel.mp4` (6:03, все 33 ячейки) + исходные клипы, постеры, сценарий и текст закадра |
