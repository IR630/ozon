...
**Цена решения, измеренная 28.07 на одном ядре и одном протоколе:** маршрутизация
у стоек равная, точность измерения неразличима, а **пропускная способность
6 товаров/мин у трёх головок против 9 у одной** — треть производительности за
геометрическую избыточность, которая на нашем каталоге вердикт не меняет.
Полный разбор — `docs/cameras-under-noise-brief.md`.
