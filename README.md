...
Полный разбор — `docs/cameras-under-noise-brief.md`, журнал — `docs/experiments.md`
(28.07). Исторический run-to-run диапазон прежних ревизий — 162–165/165; ранее
...
(`docs/report/video/`, H.264, 2,8 МБ) — дека обязана работать из чистого клона;
