...
**33/33**, таймаутов и execution-ошибок нет. Отдельный multi-seed замер на пяти
seed до depth-scale fix дал честный run-to-run диапазон 162–165/165; новый фикс
проверен одним полным seed и потому не переобъявляет это число. Устойчивая
