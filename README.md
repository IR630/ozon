...
- **Презентация:** [`deck-c-ozon.html`](docs/report/slides/deck-c-ozon.html).
...
Записанный питч `defence.mp4` длится 5:17 и содержит озвучку всех 12 слайдов.
Он является дополнительным материалом и размещается в `04-presentation` вместе
с окончательной версией презентации. Исходная HTML-презентация и звуковые дорожки
для воспроизводимой сборки находятся в репозитории.
